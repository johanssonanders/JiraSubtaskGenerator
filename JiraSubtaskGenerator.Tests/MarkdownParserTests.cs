...
namespace JiraSubtaskGenerator.Tests
{
  public class MarkdownParserTests
  {
    ...
    public void ParsesHeaderAndSubtasksCorrectly()
    {
      ...
      Assert.Equal($"Some test{Environment.NewLine}on multiple lines{Environment.NewLine}", subtask1.Description);
      ...
      Assert.Equal(4, subtask2.EstimatedHours);
        ...
        [Fact]
    public void ParsesHeaderAndSubtasksCorrectlyOnLinuxFormat()
    {
      var markdown = "@PROJ1:STORY-123\n## Task One || 2\r\nSome test\non multiple lines\n## Task Two || 4";
      var result = MarkdownParser.TryParse(markdown, out var batch);
